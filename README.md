...
**Last updated:** `2026-08-24T17:11:42Z`

**Recent commits (last 5 on HEAD):**

- `eb4768e` docs: reflect linux-port-pr merge (3-platform support) + wire pre-commit hook _(11 days ago)_
- `a3eece5` Merge linux-port-pr: Linux (Ubuntu/GNOME Wayland) port + macOS Gemini paste/submit hardening + native Gemini.app _(11 days ago)_
- `c063ba5` feat(mac): switch Gemini target from Safari-WebApp PWA to native Gemini.app _(4 weeks ago)_
- `2ed4bd1` docs: record 2026-07-26 finding — live macOS init.lua diverged from repo, lost keyStroke targeting + Gemini paste/submit hardening fixes _(4 weeks ago)_
- `47255a9` fix(mac): harden Gemini paste by using AXValue set before Cmd+V _(5 weeks ago)_
